...
CREATE UNIQUE INDEX IF NOT EXISTS idx_financial_metrics_company_id_period_id_line_item_id_value_type_source_file ON financial_metrics (company_id, period_id, line_item_id, value_type, source_file);
